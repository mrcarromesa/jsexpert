...
describe('Test suit for Template Mthod design parttern', () => {
  ...
  describe('#OrderBusiness', () => {
    test('execution Oder Business without Template Method', () => {
    ...
    test('execution Order Business with Template Method', () => {
      ...
      const calledValidateFn = jest.spyOn(
        orderBusiness,
      ...
      // com template method, a sequencia de passsos é sempre executada
      // evita a replicacao de lógica
      const result = orderBusiness.create(order)
      expect(result).toBeTruthy()
      expect(calledValidateFn).toHaveBeenCalledTimes(1)
