...
async function dbConnection() {
  const client = new MongoClient("mongodb://mongoadmin:secret@localhost:27017");
...
const { collections, client } = await dbConnection();
...
const onStop = async (signal) => {
  ...
  // => aqui podemos tentar encerrar a aplicação, e o banco de dados de forma segura.
  // para garantir que nada quebre ao encerrar a aplicação
