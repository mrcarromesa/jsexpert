...
describe('CarService Suite Test', () => {
  ...
  it('should choose the first id from carIds in carCategory', () => {
    ...
    sandbox.stub(
      carService,
      carService.getRandomPositionFromArray.name // assim ele retorna o nome dessa funcao.. poderia ser uma string mas assim fica mais senior...
    ).returns(carIdIndex)
  ...
  it('given a carCategory, customer and numberOfDays it should calculate final amount in real', async () => {
    ...
    // age: 37.6 * 1.3 = 48.88 * 5 days = 244,40
  ...
  it('give a customer and a car category it should return a transaction receipt', async () => {
    ...
    const result = await carService.rend(
